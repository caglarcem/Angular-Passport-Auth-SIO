...
function ClaimCtrl($scope, masModel, masHelper, socket,$q,serviceCodes,masCrud)//,myServiceCode2)
{
  ...
  // add one week exactly
    ...
    $scope.myDefs2 = [
        ...
        { field: 'WORK_DATE', displayName: 'Date', width: 85, cellTemplate: cellTemplate3,cellFilter:'date' },
        ...
        { field: 'WORK_TIME', displayName: 'Time', width: 55, cellTemplate: cellTemplate3 },
        { field: 'MILEAGE', displayName: 'Mileage', width: 65},
        { field: 'EXPENSE', displayName: 'Expsense Amt', width: 55, cellTemplate: cellTemplate3,cellFilter:'currency' },
        { field: 'expensedesc', displayName: 'Expsense Type', width: 75, cellTemplate: cellTemplate3 },
        { field: 'DAILY_DETAIL_ID', displayName: 'DailyDetailID', groupable: false, width: 55, cellTemplate: cellTemplate3,visible:false },
        { field: 'DAILY_ID', displayName: 'Daily Id', groupable: true, width: 55, cellTemplate: cellTemplate3,visible:false },
        { field: 'AR_ID', displayName: 'ARID', width: 55, cellTemplate: cellTemplate3 ,visible:false },
        { field: 'AR_DATE', displayName: 'Ar Date', width: 55, cellTemplate: cellTemplate3 ,visible:false },
        { field: 'CLAIM_NO', displayName: 'ClaimNo', width: 65, cellTemplate: cellTemplate3 ,visible:false },
        { field: 'WEEKOF', displayName: 'WK#', width: 45,visible:false },
